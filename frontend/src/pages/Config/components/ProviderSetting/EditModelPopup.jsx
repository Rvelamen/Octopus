...
const EditModelPopup = ({ isOpen, onClose, model, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: error.message || 'Failed to update model' });
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container edit-model-modal" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="edit-model-form">
          ...
          <div className="form-item">
            ...
            <input
              ...
              disabled={true} // Model ID cannot be changed
            />
            {errors.modelId && <span className="form-error">{errors.modelId}</span>}
            <span className="form-hint">Model ID cannot be changed after creation</span>
          </div>
