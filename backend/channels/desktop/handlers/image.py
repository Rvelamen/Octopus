...
class ImageUploadHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: ImageUploadRequest) -> None:
        """Save uploaded image to workspace."""
        try:
...
class FileUploadHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: FileUploadRequest) -> None:
        """Save uploaded file to workspace."""
        try:
...
class ImageAnalyzeHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: ImageAnalyzeRequest) -> None:
        """Analyze image using vision model."""
        try:
            from backend.services.image_service import ImageService
...
class ImageGenerateHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: ImageGenerateRequest) -> None:
        """Generate image using AI model."""
        try:
            from backend.services.image_service import ImageService
...
class ImageGetUnderstandingProvidersHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: ImageGetUnderstandingProvidersRequest) -> None:
        """Return all image understanding providers from AI providers."""
        try:
            from backend.services.image_service import ImageService
...
class ImageGetGenerationProvidersHandler(MessageHandler):
    ...
    async def handle_validated(self, websocket: WebSocket, message: WSMessage, validated: ImageGetGenerationProvidersRequest) -> None:
        """Return all image generation providers from AI providers."""
        try:
            from backend.services.image_service import ImageService
